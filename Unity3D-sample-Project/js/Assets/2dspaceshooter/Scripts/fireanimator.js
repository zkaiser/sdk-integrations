...
if(counter > 0 && GetComponent.<Renderer>().material.mainTexture != fire1){
GetComponent.<Renderer>().material.mainTexture = fire1;
}
if(counter > 1 && GetComponent.<Renderer>().material.mainTexture != fire2){
GetComponent.<Renderer>().material.mainTexture = fire2;
}
if(counter > 2 && GetComponent.<Renderer>().material.mainTexture != fire3){
GetComponent.<Renderer>().material.mainTexture = fire3;
}
if(counter > 3 && GetComponent.<Renderer>().material.mainTexture != fire2){
GetComponent.<Renderer>().material.mainTexture = fire2;
}
if(counter > 4){
